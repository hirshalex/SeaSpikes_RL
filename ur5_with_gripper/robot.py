...
class RobotBase(object):
    ...
    def get_ee_pose(self):
        """
        Return world position + orientation of the robot's end effector.
        Uses eef_id, which is set by each robot subclass (UR5, Panda, etc.)
        """
        pos, orn = p.getLinkState(self.id, self.eef_id)[4:6]
        return pos, orn
...
class UR5Robotiq140(UR5Robotiq85):
    def __init_robot__(self):
        ...
        urdf_path = os.path.join(os.path.dirname(__file__), "urdf", "ur5_robotiq_140.urdf")
